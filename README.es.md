...
- **Menú Ajustes con Acerca de**: el menú de engranaje abre Acerca de, que muestra la versión (1.0.12) y un enlace al código fuente.
...
- **Chequeo de actualizaciones en la app**: el menú de Ajustes tiene "Comprobar actualizaciones", que fuerza una consulta a la última release de GitHub y te dice si estás al día o te muestra un enlace a las notas de la versión.
