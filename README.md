...
<p align="center"><a href="https://stats.cloudless.club"><strong>Try the live demo →</strong></a>&nbsp;&nbsp;·&nbsp;&nbsp;<a href="https://goatdash.cloudless.club">Landing page</a>&nbsp;&nbsp;·&nbsp;&nbsp;<a href="#installation">Run it locally</a></p>
...
- **User menu with About**: the menu opens from your user chip and shows the version (1.0.12) and a link to the source.
...
- **In-app update check**: the gear menu has "Check for updates" which force-checks the latest GitHub release and tells you if you are up to date or shows a link to the release notes.
